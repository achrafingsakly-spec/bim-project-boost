      ...
      <div className="container relative mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div 
              className="w-20 h-1.5 bg-gradient-to-r from-accent to-orange-glow rounded-full mx-auto"
              initial={{ scaleX: 0 }}
          ...
          {/* Profile card - Glass effect with hover */}
          <motion.div 
          ...
          >
            <div className="flex flex-col md:flex-row gap-10 items-start">
              ...
              <div className="flex-1">
                ...
                {/* Key message */}
                <motion.p 
                  className="text-xl mb-8 font-medium text-primary-foreground/90 leading-relaxed"
                  initial={{ opacity: 0 }}
                ...
                {/* Credentials - Modern grid with stagger */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                  {credentials.map((cred, index) => (
                    <motion.div 
                      ...
                      className="flex items-center gap-4 p-4 bg-primary-foreground/5 rounded-xl border border-primary-foreground/10 transition-all duration-300 cursor-default"
                    >
                      <motion.div
                ...
                {/* Quote - Modern style with animation */}
                <motion.div 
          ...
          {/* Experience badge - Modern pill with hover */}
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-50px" }}
          ...
          >
            <motion.div 
              className="inline-flex flex-col sm:flex-row items-center gap-6 sm:gap-10 px-10 py-6 bg-primary-foreground/5 backdrop-blur-xl rounded-2xl border border-primary-foreground/10 shadow-xl"
